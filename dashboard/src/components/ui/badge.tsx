  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        completed: "border-transparent bg-success/15 text-success border-success/30",
        pending: "border-transparent bg-warning/15 text-warning border-warning/30",
        failed: "border-transparent bg-destructive/15 text-destructive border-destructive/30",
        revoked: "border-transparent bg-destructive/15 text-destructive border-destructive/30",
      },
    },
    defaultVariants: {
      variant: "default",
